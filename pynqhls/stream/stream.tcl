...
################################################################
# This is a generated script based on design: stream
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: dmaInterconnect, and set properties
  set dmaInterconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 dmaInterconnect ]
  set_property -dict [ list \
CONFIG.NUM_MI {1} \
 ] $dmaInterconnect

  # Create instance: filt1d, and set properties
  set filt1d [ create_bd_cell -type ip -vlnv UCSD:hls:filt1d:1.0 filt1d ]

  # Create instance: hlsDmaEngine, and set properties
  set hlsDmaEngine [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 hlsDmaEngine ]
  set_property -dict [ list \
...
CONFIG.NUM_PORTS {3} \
  ...
  # Create instance: mmioInterconnect, and set properties
  set mmioInterconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 mmioInterconnect ]
  set_property -dict [ list \
CONFIG.NUM_MI {3} \
 ] $mmioInterconnect

  # Create instance: plInterruptController, and set properties
  set plInterruptController [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 plInterruptController ]
...
CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins mmioInterconnect/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins dmaInterconnect/S00_AXI] [get_bd_intf_pins hlsDmaEngine/M_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins filt1d/INPUT_r] [get_bd_intf_pins hlsDmaEngine/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins filt1d/s_axi_CTRL] [get_bd_intf_pins mmioInterconnect/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins hlsDmaEngine/S_AXI_LITE] [get_bd_intf_pins mmioInterconnect/M01_AXI]
  connect_bd_intf_net -intf_net dmaInterconnect_M00_AXI [get_bd_intf_pins dmaInterconnect/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net filt1d_0_OUTPUT_r [get_bd_intf_pins filt1d/OUTPUT_r] [get_bd_intf_pins hlsDmaEngine/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net mmioInterconnect_M02_AXI [get_bd_intf_pins mmioInterconnect/M02_AXI] [get_bd_intf_pins plInterruptController/s_axi]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hlsDmaEngine/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs filt1d/s_axi_CTRL/Reg] SEG_filt1d_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hlsDmaEngine/S_AXI_LITE/Reg] SEG_hlsDmaEngine_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40002000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs plInterruptController/S_AXI/Reg] SEG_plInterruptController_Reg
