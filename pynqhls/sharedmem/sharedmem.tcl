...
################################################################
# This is a generated script based on design: sharedmem
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mmultCore, and set properties
  set mmultCore [ create_bd_cell -type ip -vlnv UCSD:hls:mmult:1.0 mmultCore ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net mmultCore_m_axi_DATA [get_bd_intf_pins mmultCore/m_axi_DATA] [get_bd_intf_pins plInterconnect/S00_AXI]
  ...
  connect_bd_intf_net -intf_net psInterconnect_M00_AXI [get_bd_intf_pins mmultCore/s_axi_CTRL] [get_bd_intf_pins psInterconnect/M00_AXI]
  ...
  connect_bd_net -net mmultCore_interrupt [get_bd_pins mmultCore/interrupt] [get_bd_pins plIrqConcat/In0]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces mmultCore/Data_m_axi_DATA] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mmultCore/s_axi_CTRL/Reg] SEG_mmultCore_Reg
