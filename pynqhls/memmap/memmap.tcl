...
################################################################
# This is a generated script based on design: memmap
#
...
CONFIG.NUM_MI {2} \
  ...
  # Create instance: vvaddCore, and set properties
  set vvaddCore [ create_bd_cell -type ip -vlnv UCSD:hls:vvadd:1.0 vvaddCore ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /vvaddCore/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins psInterconnect/M00_AXI] [get_bd_intf_pins vvaddCore/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net vvadd_0_m_axi_L [get_bd_intf_pins plInterconnect/S00_AXI] [get_bd_intf_pins vvaddCore/m_axi_L]
  connect_bd_intf_net -intf_net vvadd_0_m_axi_OUTPUT_r [get_bd_intf_pins plInterconnect/S02_AXI] [get_bd_intf_pins vvaddCore/m_axi_OUTPUT_r]
  connect_bd_intf_net -intf_net vvadd_0_m_axi_R [get_bd_intf_pins plInterconnect/S01_AXI] [get_bd_intf_pins vvaddCore/m_axi_R]

  # Create port connections
  connect_bd_net -net FCLK_CLK0 [get_bd_pins plInterconnect/ACLK] [get_bd_pins plInterconnect/M00_ACLK] [get_bd_pins plInterconnect/S00_ACLK] [get_bd_pins plInterconnect/S01_ACLK] [get_bd_pins plInterconnect/S02_ACLK] [get_bd_pins plIntrController/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins psInterconnect/ACLK] [get_bd_pins psInterconnect/M00_ACLK] [get_bd_pins psInterconnect/M01_ACLK] [get_bd_pins psInterconnect/S00_ACLK] [get_bd_pins userReset/slowest_sync_clk] [get_bd_pins vvaddCore/ap_clk]
  ...
  connect_bd_net -net S00_ARESETN_2 [get_bd_pins plInterconnect/M00_ARESETN] [get_bd_pins plInterconnect/S00_ARESETN] [get_bd_pins plInterconnect/S01_ARESETN] [get_bd_pins plInterconnect/S02_ARESETN] [get_bd_pins plIntrController/s_axi_aresetn] [get_bd_pins psInterconnect/M00_ARESETN] [get_bd_pins psInterconnect/M01_ARESETN] [get_bd_pins psInterconnect/S00_ARESETN] [get_bd_pins userReset/peripheral_aresetn] [get_bd_pins vvaddCore/ap_rst_n]
  ...
  connect_bd_net -net vvadd_0_interrupt [get_bd_pins plIrqConcat/In0] [get_bd_pins vvaddCore/interrupt]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vvaddCore/s_axi_CTRL/Reg] SEG_vvaddCore_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces vvaddCore/Data_m_axi_L] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces vvaddCore/Data_m_axi_R] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces vvaddCore/Data_m_axi_OUTPUT_r] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
